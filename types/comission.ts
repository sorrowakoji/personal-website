...
export const commissionCategories: CommissionCategory[] = [
    ...
    tiers: [
      {
        ...
        description: "Simple highlight videos and stream edits.",
...

      {
        ...
        description: "More advanced editing and pacing.",
...

      {
        ...
        description: "Heavy editing, motion graphics and priority queue.",
...

  {
    ...
    description: "TikTok, Shorts, Reels and clip editing.",
    ...
    tiers: [
      {
        ...
        description: "Simple clip editing and highlights.",
...

  {
    id: "casting",
    title: "Casting",
    description: "Tournament commentary and hosting services.",
    ...
    tiers: [
      {
        ...
        description: "Play-by-play and color commentary.",
    ...
    tiers: [
      {
        ...
        description: "Website and stream widgets.",
...

      {
        ...
        description: "Custom simple overlay for tournaments.",

        icon: MessageSquareCode,

        features: ["Score overlays", "API integration"],
...

      {
        ...
        description: "Interactive browser games and stream tools.",
